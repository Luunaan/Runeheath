...
#define LOG_DIRECT_MESSAGE	(1 << 20)
#define LOG_TELEPATHY		(1 << 21)
#define LOG_PHEROMONES		(1 << 22)
...
#define INDIVIDUAL_SHOW_ALL_LOG		(LOG_ATTACK | LOG_SAY | LOG_WHISPER | LOG_EMOTE | LOG_DSAY | LOG_PDA | LOG_CHAT | LOG_COMMENT | LOG_TELECOMMS | LOG_OOC | LOG_ADMIN | LOG_OWNERSHIP | LOG_GAME | LOG_DIRECT_MESSAGE | LOG_TELEPATHY | LOG_PHEROMONES)
