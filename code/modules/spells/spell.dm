...
#define FATIGUE_REDUCTION_PER_INT 0.08 // The amount of fatigue reduction per point of intelligence above / below threshold
#define COOLDOWN_REDUCTION_PER_INT 0.10 // The amount of cooldown reduction per point of intelligence above / below threshold
