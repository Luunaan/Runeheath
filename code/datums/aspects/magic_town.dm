/datum/round_aspect/magic_town
	...
	description = "All characters gain the Arcane skill and two random spells on round start."
	round_start_text = "Strong ambient magic has left its mark here - even the lowliest beggar has some ability to cast spells..."
	weight = 25
	var/const/spells_per_person = 2
	var/const/max_spell_level = 2
	var/list/valid_spells = list()

/datum/round_aspect/magic_town/on_selection()
	..()
...
/datum/round_aspect/magic_town/proc/spell_is_allowed(obj/effect/proc_holder/spell/spell)
